...
const PasswordInput: FC<PasswordInputProps> = ({ className, disabled, ref, ...props }) => {
  const [showPassword, setShowPassword] = useState(false)
  return (
    <div className={cn('rounded-2md relative', className)}>
      <input
        ref={ref}
        {...props} // Bind additional properties, such as properties injected by react-hook-form.
      ...
      <Button
        ...
        variant="ghost"
        disabled={disabled}
        type="button" // Prevent the form from being submitted by default.
